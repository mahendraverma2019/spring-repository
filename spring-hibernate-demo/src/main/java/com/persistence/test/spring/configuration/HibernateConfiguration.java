package com.persistence.test.spring.configuration;
...
@ComponentScan({ "com.persistence.test.spring.configuration" })
...
public class HibernateConfiguration {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan(new String[] { "com.persistence.test.spring.model" });
	...
	private Properties hibernateProperties() {
		...
		properties.put("spring.jpa.properties.hibernate.id.new_generator_mappings",
